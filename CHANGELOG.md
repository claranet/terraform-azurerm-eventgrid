...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) c3e3364

### Bug Fixes

* **SREAA-368:** 🐛 migrate queue_properties to its dedicated resource in the examples 2b9cdba

### Documentation

* **SREAA-368:** regenerate submodule READMEs for v9 b06bc0e

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 01f3d85
* **deps:** update dependency tflint to v0.64.0 7ec2104
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 45098dd
* **v9:** 🐛 synchronize common files and docs 79802ac

## 8.2.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 7e4451b

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 e06b96e
* **deps:** update dependency opentofu to v1.12.2 671fd2c
* **deps:** update dependency opentofu to v1.12.3 e6cfaf9
* **deps:** update dependency opentofu to v1.12.4 f4e57cd
* **deps:** update dependency tflint to v0.63.1 8f6fb5a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 8dbc26d
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 25b13ca
...
* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ b452565

### Code Refactoring

* update module structure and Github actions 👷 6e5baf4

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 6bde6be
* **deps:** update dependency trivy to v0.69.3 74f9651
